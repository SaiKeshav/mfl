...
#             dataset = [e for e in f]
        ...
        dataset = []
        for line_no, (s, t) in enumerate(zip(source_lines, target_lines)):
            dataset.append({'id': line_no, 'input': s.strip(), 'gold': t.strip(), 'output': {'answer': t.strip()}})
